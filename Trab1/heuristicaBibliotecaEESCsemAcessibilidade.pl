%heuristica a*- destino 3 :  biblioEESC
:- multifile heuristica/3.

%heuristica(pontoa, pontob, valor) valor em metros
heuristica(onibus, biblioEESC, 525.54).
heuristica(saidaArq, biblioEESC, 585.86).
heuristica(matematica, biblioEESC, 157.47).
heuristica(entradafisica, biblioEESC, 258.26).
heuristica(entradaprod, biblioEESC, 440.23).
heuristica(cefer, biblioEESC, 210.57).
